...
class ConsumerPong(AsyncWebsocketConsumer):
	active_games = {}
	waiting_players = []
	...
	async def receive(self, text_data):
		...
		if data['type'] == 'requestMatch'	: await self.handle_request_match()
		elif data['type'] == 'joinRoom'		: await self.handle_join_room(data['roomId'], data['side'])
