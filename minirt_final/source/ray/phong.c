...
/*   Updated: 2024/01/25 12:06:13 by donghyu2         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
static void		adjust_color(t_color *dim, t_color *high, t_phong phong, t_scl len_to_light);
...
static void	adjust_color(t_color *dim, t_color *high, t_phong phong, t_scl len_to_light)
{
	// printf("diff %.2f, specular %.2f\n", phong.diffuse, phong.specular);
	*dim = ad(*dim,
		mt(light_attenuation(phong.light, len_to_light), phong.diffuse));
	*high = ad(*high,
		mt(mt(mt(light_attenuation(phong.light, len_to_light),
